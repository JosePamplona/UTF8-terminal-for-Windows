...
1. Open a ***PowerShell*** terminal and run:
    ...
    Some motherboards BIOS may not have virtualization options (SVM) enabled by default. To enable system virtualization, consult the documentation matching the motherboard model and BIOS version in order to enable it.
